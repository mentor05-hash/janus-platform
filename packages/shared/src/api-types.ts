...
export interface paths {
    ...
    "/admin/staff": {
        ...
        get?: never;
        put?: never;
        /** 관리자 계정 생성 — 본사 이상(L2 생성은 마스터 L1만) */
        post: {
            parameters: {
                query?: never;
                header?: never;
