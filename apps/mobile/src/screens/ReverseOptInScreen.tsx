...
export function ReverseOptInScreen() {
  ...
  return (
    <ScrollView style={ui.screen} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      <Text style={[ui.sub, { marginBottom: SP.md }]}>역상담은 선생님이 먼저 상담을 제안하는 기능입니다. 켜면 첫 상담 이후에도 선생님이 회원님에게 상담을 제안할 수 있어요. 받은 제안은 <Text style={{ fontWeight: '800' }}>내 예약</Text> 탭에서 수락/거절할 수 있어요.</Text>
      {value === null && !error ? (
