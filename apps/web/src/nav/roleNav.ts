...
export const MOBILE_TABS = {
  ...
  /**
   * 모바일 학부모 탭은 홈·상담·멤버십·결제·충전 인데, 웹에서 멤버십·결제·충전은
   * **한 화면**(`/guardian/pay`)이고 웹의 '동의·본인확인'은 모바일 탭에 대응이 없다.
   * 즉 이쪽은 모바일 탭 배분이 결제에 과대 대표된 것이라, 웹은 4개로 두고
   * 모바일 정리는 후속으로 미룬다(그때 이 배열을 함께 고친다).
   */
