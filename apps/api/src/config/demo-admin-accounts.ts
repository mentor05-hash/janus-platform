 ...
 */
export const DEMO_ADMIN_LOGIN_IDS = ['admin01', 'hq01', 'master01', 'hr01'] as const;
...
export function demoAdminPassword(env: NodeJS.ProcessEnv = process.env): string | null {
...
export function demoPasswordFor(loginId: string, env: NodeJS.ProcessEnv = process.env): string {
