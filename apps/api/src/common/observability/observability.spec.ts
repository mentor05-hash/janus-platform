...
describe('관측성(§10)', () => {
  it('formatLogLine 은 한 줄 JSON', () => {
    const line = formatLogLine({ level: 'info', time: '2026-01-01T00:00:00.000Z', context: 'X', requestId: 'r1', message: 'hi' });
    expect(line.includes('\n')).toBe(false);
    const o = JSON.parse(line);
    expect(o).toEqual({ level: 'info', time: '2026-01-01T00:00:00.000Z', context: 'X', requestId: 'r1', message: 'hi' });
  });
