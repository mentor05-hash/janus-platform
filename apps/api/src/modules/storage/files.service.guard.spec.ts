...
describe('FilesService.upload × 생기부 가드', () => {
  it('생기부 감지 → 예외 + storage·DB 미기록', async () => {
    ...
    await expect(service.upload('owner-1', file(MOCK_SR_TEXT))).rejects.toBeInstanceOf(
